...
- technically, a Pod have can any number of containers, however as per best practice one container per Pod is recommended. The infra container is not counted, it is mandatory and managed by Kubernetes/Openshift internally.
...
- every Pod should represent just one application
</pre>
